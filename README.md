...
* Implementacion de ventanas y botones utiles para el manejo de la interfaz de usuario dependiendo de su rol dentro del proyecto [>vista + Launcher.java], tambien la creacion del archivo launcher. Desarrollo realizado por Patricio.   
